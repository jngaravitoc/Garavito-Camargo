...
Astronomy community. Below you can find outreach and DEI activities
...
Since August 2020 I've been leading a mentorship program for undergraduate physics and astronomy students in Colombia. The program aims to guide the students to reach their professional goals. These include an academic career in astronomy, an educator career, or a path within industry. Until now, the program has had over 60 students! 

## [RECA internship program](https://www.astroreca.org/en/internship) 

In summer 2021 I co-organized the astronomy internship program with the Colombian Network of Students (RECA). During the 10 week program 13 students in Colombia made research projects with Astronomers all over the world. This online program provided an opportunity for the students to work directly with Astronomers from all over the world. 
...
I used to organize along with [Samantha Scibelli](https://samscibelli.github.io/), Erin Maier, and
[Carlos Vargas](https://www.as.arizona.edu/people/postdoctoral/carlos-j-vargas)
the [diversity Journal Club](https://www.as.arizona.edu/diversity_coffee)
at the Astronomy department in the Steward Observatory. This was a space created
...
<img src="{{ site.baseurl }}/images/outreach/astrobitos.png" width="600">

I've been a writer for Astrobitos since 2017. 
...
| <img src="{{ site.baseurl }}/images/outreach/astronomiaperiferica.jpg" width="400"> |  Astronomia periferica was a program funded by the IAU [office for
development](http://www.astro4dev.org/) that took place in Bogota, Colombia. Astronomia periferica was targeted to 
kids from underprivileged neighborhoods in Bogotá. We did several hands-on activities that involved science and arts motivated by physical concepts, such as light, 
